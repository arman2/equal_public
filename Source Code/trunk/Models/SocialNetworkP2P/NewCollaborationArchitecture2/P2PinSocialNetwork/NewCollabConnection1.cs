...
namespace Simulation.P2PinSocialNetworkContext
{
    ...
    public class NewCollabConnection1 : DP_Link, DP_ILink
    {
        public P2PinSocialNetwork P2PinSocialNetwork;

        private P2PinSocialNetworkContext.PeerContext.CreateMsg CreateMsgInstance;

        public P2PinSocialNetworkContext.PeerContext.CreateMsg CreateMsg
        {
          get
          {
          ...
          set
          {
            CreateMsgInstance = (P2PinSocialNetworkContext.PeerContext.CreateMsg)value;
            if (Role1 != value)
            {
              Role1 = value;
            }
