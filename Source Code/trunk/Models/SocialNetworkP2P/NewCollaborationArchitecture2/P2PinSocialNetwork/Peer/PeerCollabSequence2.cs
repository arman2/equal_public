...
namespace Simulation.P2PinSocialNetworkContext.PeerContext
{
    ...
    public class PeerCollabSequence2 : DP_Flow, DP_IFlow
    {
        public Peer Peer;
        ...
        {
          P2PinSocialNetworkContext.PeerContext.FwdCreate FwdCreate = source as P2PinSocialNetworkContext.PeerContext.FwdCreate;
return true;
        }
