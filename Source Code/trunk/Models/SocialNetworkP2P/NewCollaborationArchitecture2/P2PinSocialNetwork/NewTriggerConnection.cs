...
namespace Simulation.P2PinSocialNetworkContext
{
    ...
    public class NewTriggerConnection : DP_Link, DP_ILink
    {
        ...
        private P2PinSocialNetworkContext.PeerNetworkContext.CacheMsg CacheMsgInstance;

        public P2PinSocialNetworkContext.PeerNetworkContext.CacheMsg CacheMsg
        {
          get
          {
            return CacheMsgInstance;
          }
          set
          {
            CacheMsgInstance = (P2PinSocialNetworkContext.PeerNetworkContext.CacheMsg)value;
            if (Role2 != value)
            {
              Role2 = value;
            }
