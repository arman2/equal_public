...
namespace Simulation.P2PinSocialNetworkContext
{
    ...
    public class NewTriggerConnection2 : DP_Link, DP_ILink
    {
        ...
        private P2PinSocialNetworkContext.PeerContext.Read ReadInstance;

        public P2PinSocialNetworkContext.PeerContext.Read Read
        {
          get
          {
            return ReadInstance;
          ...
          set
          {
            ReadInstance = (P2PinSocialNetworkContext.PeerContext.Read)value;
            if (Role2 != value)
            {
              Role2 = value;
            }
