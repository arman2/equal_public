...
namespace Simulation.MonSysContext.PubSubMWContext.EventCoordContext
{
    ...
    public class EventDict : DP_Data, DP_IData
    {
        ...
        public new Dictionary<Simulation.MonSysContext.AgentContext.Subscriber,NfyMsg> Value
        {
          get
          {
            return (Dictionary<Simulation.MonSysContext.AgentContext.Subscriber,NfyMsg>)val;
          }
          set
          {
        ...
        public override void Initialize()
        {
          base.Initialize();
            ...
            Value = new Dictionary<Simulation.MonSysContext.AgentContext.Subscriber,NfyMsg>();
        }
