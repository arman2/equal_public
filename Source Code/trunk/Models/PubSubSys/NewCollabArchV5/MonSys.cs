...
namespace Simulation
{
    ...
    public class MonSys : DP_Component, DP_IComponent
    {
        ...
        private List<NewFocusOnObjConn2> NewFocusOnObjConn2Instances = new List<NewFocusOnObjConn2>();

        public List<NewFocusOnObjConn2> NewFocusOnObjConn2List
        {
          get
          {
            return NewFocusOnObjConn2Instances;
          }
          set
          {
            NewFocusOnObjConn2Instances = value;
          }
        }
