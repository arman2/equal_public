...
namespace Simulation.SmartRedundancySystemContext.SimpleJobServerContext
{
    ...
    public class FinishedHandleResult : DP_Flow, DP_IFlow
    {
        ...
        {
          SmartRedundancySystemContext.SimpleJobServerContext.HandleResult HandleResult = source as SmartRedundancySystemContext.SimpleJobServerContext.HandleResult;
return true;
        }
