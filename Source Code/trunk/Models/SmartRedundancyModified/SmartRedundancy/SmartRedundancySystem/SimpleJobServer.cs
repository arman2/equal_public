...
namespace Simulation.SmartRedundancySystemContext
{
    ...
    public class SimpleJobServer : DP_Component, DP_IComponent
    {
        ...
        private TotalExecutionTime TotalExecutionTimeInstance;

        public TotalExecutionTime TotalExecutionTimeData
        {
          get
          {
            return TotalExecutionTimeInstance;
          }
          set
          {
            TotalExecutionTimeInstance = value;
          }
        }
        ...
        public double TotalExecutionTime
        {
          get
          {
            return TotalExecutionTimeInstance.Value;
          }
          set
          {
            TotalExecutionTimeInstance.Value = value;
          }
        }

        private Cost CostInstance;

        public Cost CostData
        {
          get
          {
            return CostInstance;
        ...
        public double Cost
        {
          get
          {
            return CostInstance.Value;
          }
          set
          {
            CostInstance.Value = value;
          }
        }
        ...
        public SmartRedundancySystemContext.Problem NewProblemSubmission
        {
          get
          {
        ...
        public override void Initialize()
        {
          ...
          TotalExecutionTimeInstance = (TotalExecutionTime)Create("TotalExecutionTime");
          CostInstance = (Cost)Create("Cost");
