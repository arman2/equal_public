...
namespace Simulation.HuaweiTestingContext.TestSchedulerContext
{
    ...
    public class HandleResult : DP_Method, DP_IMethod
    {
        ...
        public HuaweiTestingContext.TestSchedulerContext.UniformTestQueue EndOfQueue
        {
          get
          {
            return EndOfQueueInstance.UniformTestQueue;
          }
          set
          {
            EndOfQueueInstance.UniformTestQueue = value;
          }
        }
