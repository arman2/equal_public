...
namespace Simulation.HuaweiTestingContext.TestSchedulerContext
{
    ...
    public class UniformTestQueue : DP_Data, DP_IData
    {
        ...
        public HuaweiTestingContext.TestSchedulerContext.GetNextJob FrontOfQueue
        {
          get
          {
        ...
        public HuaweiTestingContext.TestSchedulerContext.HandleResult EndOfQueue
        {
          get
          {
