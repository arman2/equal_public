...
namespace Simulation.MonSysContext.PubSubMWContext
{
    ...
    public class EventCoord : DP_Component, DP_IComponent
    {
        ...
        public Dictionary<Simulation.MonSysContext.AgentContext.SubscriberComp,NfyMsg> EventDict
        {
          get
          {
        ...
        public MonSysContext.NfyMsg NewFocusOnObjConn1
        {
          get
          {
            return NewFocusOnObjConn1Instance.NfyMsg;
          }
          set
          {
            NewFocusOnObjConn1Instance.NfyMsg = value;
          }
        }
