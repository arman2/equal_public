...
namespace Simulation.MonSysContext.NfyMsgContext
{
    ...
    public class Receiver : DP_Data, DP_IData
    {
        public NfyMsg NfyMsg;

        public new Simulation.MonSysContext.AgentContext.SubscriberComp Value
        {
          get
          {
            return (Simulation.MonSysContext.AgentContext.SubscriberComp)val;
          }
          set
          {
