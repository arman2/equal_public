...
{
    using PublisherCompContext;

    public class PublisherComp : DP_Component, DP_IComponent
    {
        public Agent Agent;

        public System.Double InverseTopicRatio
        {
          get { return ((Publisher)Type).InverseTopicRatio; }
        }
