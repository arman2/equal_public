...
namespace Simulation.MonSysContext.AccessCoordinatorContext.ConflictDetectionContext
{
    ...
    public class OutQueue : DP_Data, DP_IData
    {
        public ConflictDetection ConflictDetection;

        public new Queue<Simulation.MonSysContext.StatusArtifactContext.Update> Value
        {
          get
          {
            return (Queue<Simulation.MonSysContext.StatusArtifactContext.Update>)val;
          }
          set
          {
        ...
        public override void Initialize()
        {
          base.Initialize();
            ...
            Value = new Queue<Simulation.MonSysContext.StatusArtifactContext.Update>();
        }
