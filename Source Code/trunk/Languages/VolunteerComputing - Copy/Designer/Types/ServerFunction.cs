...
{
    public class ServerFunction : DP_Shape
    {
        ...
        public ServerFunction(Point startLocation) :
            base(startLocation)
        {
            Diagram = new ServerFunctionStructure();
            Text = new DP_Text();
        ...
        {
            ServerFunction newType = new ServerFunction();
            newType.Diagram = new ServerFunctionStructure();
        ...
        {
            if (source is ServerFunction)
            {
              base.Copy(source);
              ServerFunction srcServerFunction = source as ServerFunction;
        ResourceDependency = srcServerFunction.ResourceDependency;
        ResourceRequest = srcServerFunction.ResourceRequest;
            }
        }
    }
}
