...
{
    public class TerminateNode : DP_Shape
    {
        ...
        public TerminateNode(Point startLocation) :
            base(startLocation)
        {
            Diagram = new TerminateNodeStructure();
            Text = new DP_Text();
        ...
        {
            TerminateNode newType = new TerminateNode();
            newType.Diagram = new TerminateNodeStructure();
        ...
        {
            if (source is TerminateNode)
            {
              base.Copy(source);
              TerminateNode srcTerminateNode = source as TerminateNode;
            }
        }
    }
}
