...
{
    public class FacilityNode : DP_Shape
    {
        ...
        public FacilityNode(Point startLocation) :
            base(startLocation)
        {
            Diagram = new FacilityNodeStructure();
            Text = new DP_Text();
        ...
        {
            FacilityNode newType = new FacilityNode();
            newType.Diagram = new FacilityNodeStructure();
        ...
        {
            if (source is FacilityNode)
            {
              base.Copy(source);
              FacilityNode srcFacilityNode = source as FacilityNode;
            }
        }
    }
}
