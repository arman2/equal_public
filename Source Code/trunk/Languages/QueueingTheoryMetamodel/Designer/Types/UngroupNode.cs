...
{
    public class UngroupNode : DP_Shape
    {
        ...
        public UngroupNode(Point startLocation) :
            base(startLocation)
        {
            Diagram = new UngroupNodeStructure();
            Text = new DP_Text();
        ...
        {
            UngroupNode newType = new UngroupNode();
            newType.Diagram = new UngroupNodeStructure();
        ...
        {
            if (source is UngroupNode)
            {
              base.Copy(source);
              UngroupNode srcUngroupNode = source as UngroupNode;
            }
        }
    }
}
