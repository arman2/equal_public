...
{
    public class QueueNode : DP_Shape
    {
        ...
        public QueueNode(Point startLocation) :
            base(startLocation)
        {
            Diagram = new QueueNodeStructure();
            Text = new DP_Text();
        ...
        {
            QueueNode newType = new QueueNode();
            newType.Diagram = new QueueNodeStructure();
        ...
        {
            if (source is QueueNode)
            {
              base.Copy(source);
              QueueNode srcQueueNode = source as QueueNode;
            }
        }
    }
}
