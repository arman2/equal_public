...
{
    public class DelayNode : DP_Shape
    {
        ...
        public DelayNode(Point startLocation) :
            base(startLocation)
        {
            Diagram = new DelayNodeStructure();
            Text = new DP_Text();
        ...
        {
            DelayNode newType = new DelayNode();
            newType.Diagram = new DelayNodeStructure();
        ...
        {
            if (source is DelayNode)
            {
              base.Copy(source);
              DelayNode srcDelayNode = source as DelayNode;
            }
        }
    }
}
