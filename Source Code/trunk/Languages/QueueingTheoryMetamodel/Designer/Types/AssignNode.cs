...
{
    public class AssignNode : DP_Shape
    {
        ...
        public AssignNode(Point startLocation) :
            base(startLocation)
        {
            Diagram = new AssignNodeStructure();
            Text = new DP_Text();
        ...
        {
            AssignNode newType = new AssignNode();
            newType.Diagram = new AssignNodeStructure();
        ...
        {
            if (source is AssignNode)
            {
              base.Copy(source);
              AssignNode srcAssignNode = source as AssignNode;
            }
        }
    }
}
