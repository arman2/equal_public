...
namespace Designer.Types
{
    public class GroupQ : QueueNode
    {
        ...
        public GroupQ(Point startLocation) :
            base(startLocation)
        {
            Diagram = new GroupQStructure();
            Text = new DP_Text();
        ...
        {
            GroupQ newType = new GroupQ();
            newType.Diagram = new GroupQStructure();
        ...
        protected override void Copy(DP_ConcreteType source)
        {
            ...
            {
              base.Copy(source);
              GroupQ srcGroupQ = source as GroupQ;
            }
        }
    }
}
