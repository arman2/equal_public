...
namespace Designer.Types
{
    public class MatchQ : QueueNode
    {
        ...
        public MatchQ(Point startLocation) :
            base(startLocation)
        {
            Diagram = new MatchQStructure();
            Text = new DP_Text();
        ...
        {
            MatchQ newType = new MatchQ();
            newType.Diagram = new MatchQStructure();
        ...
        protected override void Copy(DP_ConcreteType source)
        {
            ...
            {
              base.Copy(source);
              MatchQ srcMatchQ = source as MatchQ;
            }
        }
    }
}
