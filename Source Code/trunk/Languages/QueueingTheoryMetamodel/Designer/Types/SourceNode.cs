...
{
    public class SourceNode : DP_Shape
    {
        ...
        public SourceNode(Point startLocation) :
            base(startLocation)
        {
            Diagram = new SourceNodeStructure();
            Text = new DP_Text();
        ...
        {
            SourceNode newType = new SourceNode();
            newType.Diagram = new SourceNodeStructure();
        ...
        {
            if (source is SourceNode)
            {
              base.Copy(source);
              SourceNode srcSourceNode = source as SourceNode;
            }
        }
    }
}
