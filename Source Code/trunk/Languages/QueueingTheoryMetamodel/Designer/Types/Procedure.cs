...
{
    public class Procedure : DP_Shape
    {
        ...
        public Procedure(Point startLocation) :
            base(startLocation)
        {
            Diagram = new ProcedureStructure();
            Text = new DP_Text();
        ...
        {
            Procedure newType = new Procedure();
            newType.Diagram = new ProcedureStructure();
        ...
        {
            if (source is Procedure)
            {
              base.Copy(source);
              Procedure srcProcedure = source as Procedure;
            }
        }
    }
}
