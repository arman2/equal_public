...
{
    public class ResourceQ : QueueNode
    {
        ...
        public ResourceQ(Point startLocation) :
            base(startLocation)
        {
            Diagram = new ResourceQStructure();
            Text = new DP_Text();
        ...
        {
            ResourceQ newType = new ResourceQ();
            newType.Diagram = new ResourceQStructure();
        ...
        {
            if (source is ResourceQ)
            {
              base.Copy(source);
              ResourceQ srcResourceQ = source as ResourceQ;
            }
        }
    }
}
