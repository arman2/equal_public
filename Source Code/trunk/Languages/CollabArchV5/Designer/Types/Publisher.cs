...
namespace Designer.Types
{
    public class Publisher : Component
    {
        ...
        public Publisher(Point startLocation) :
            base(startLocation)
        {
            Diagram = new PublisherStructure();
            Text = new DP_Text();
        ...
        {
            Publisher newType = new Publisher();
            newType.Diagram = new PublisherStructure();
        ...
        {
            if (source is Publisher)
            {
              base.Copy(source);
              Publisher srcPublisher = source as Publisher;
              InverseTopicRatio = srcPublisher.InverseTopicRatio;
            }
        }
    }
}
