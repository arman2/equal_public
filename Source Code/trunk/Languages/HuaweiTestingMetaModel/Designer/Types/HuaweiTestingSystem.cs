...
{
    public class HuaweiTestingSystem : DP_Shape
    {
        ...
        public HuaweiTestingSystem()
        {
        }

        public HuaweiTestingSystem(Point startLocation) :
            base(startLocation)
        {
            Diagram = new HuaweiTestingSystemStructure();
            Text = new DP_Text();
        ...
        {
            HuaweiTestingSystem newType = new HuaweiTestingSystem();
            newType.Diagram = new HuaweiTestingSystemStructure();
        ...
        {
            if (source is HuaweiTestingSystem)
            {
              base.Copy(source);
              HuaweiTestingSystem srcHuaweiTestingSystem = source as HuaweiTestingSystem;
            }
        }
    }
}
