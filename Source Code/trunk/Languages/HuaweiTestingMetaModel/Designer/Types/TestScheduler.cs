...
{
    public class TestScheduler : DP_Shape
    {
        ...
        public TestScheduler(Point startLocation) :
            base(startLocation)
        {
            Diagram = new TestSchedulerStructure();
            Text = new DP_Text();
        ...
        {
            TestScheduler newType = new TestScheduler();
            newType.Diagram = new TestSchedulerStructure();
        ...
        {
            if (source is TestScheduler)
            {
              base.Copy(source);
              TestScheduler srcTestScheduler = source as TestScheduler;
            }
        }
    }
}
