...
namespace Designer.Types
{
    public class TestFlow : DP_Line
    {
        ...
        public TestFlow(DomainProDesigner.DP_ConnectionSpec newRole1, DomainProDesigner.DP_ConnectionSpec newRole2) :
            base(newRole1, newRole2)
        {
            Diagram = new TestFlowStructure();
            Text = new DP_Text();
        }
        ...
        {
            TestFlow newType = new TestFlow();
            newType.Diagram = new TestFlowStructure();
        ...
        {
            if (source is TestFlow)
            {
              base.Copy(source);
              TestFlow srcTestFlow = source as TestFlow;
            }
        }
    }
}
