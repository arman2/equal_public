...
{
    public class Container : DP_Shape
    {
        ...
        public Container(Point startLocation) :
            base(startLocation)
        {
            Diagram = new ContainerStructure();
            Text = new DP_Text();
        ...
        public override DP_ConcreteType Duplicate()
        {
            ...
            newType.Diagram = new ContainerStructure();
        ...
        protected override void Copy(DP_ConcreteType source)
        {
            ...
            {
              base.Copy(source);
              Container srcContainer = source as Container;
            }
        }
    }
}
