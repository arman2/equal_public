...
namespace Designer.Types
{
    public class JobData : DP_Shape
    {
        ...
        public JobData(Point startLocation) :
            base(startLocation)
        {
            Diagram = new JobDataStructure();
            Text = new DP_Text();
        }
        ...
        {
            JobData newType = new JobData();
            newType.Diagram = new JobDataStructure();
        ...
        {
            if (source is JobData)
            {
              base.Copy(source);
              JobData srcJobData = source as JobData;
        ImplementationType = srcJobData.ImplementationType;
        InitialValue = srcJobData.InitialValue;
            }
        }
    }
}
