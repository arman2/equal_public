...
{
    public class JobDefinition : DP_Shape
    {
        ...
        public JobDefinition(Point startLocation) :
            base(startLocation)
        {
            Diagram = new JobDefinitionStructure();
            Text = new DP_Text();
        ...
        {
            JobDefinition newType = new JobDefinition();
            newType.Diagram = new JobDefinitionStructure();
        ...
        {
            if (source is JobDefinition)
            {
              base.Copy(source);
              JobDefinition srcJobDefinition = source as JobDefinition;
            }
        }
    }
}
