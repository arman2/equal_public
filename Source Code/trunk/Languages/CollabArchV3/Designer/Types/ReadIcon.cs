...
{
    public class ReadIcon : ActionIcon
    {
        ...
        protected override void SetParams()
        {
            ...
            ShapeProperties.Icon = "..\\..\\Icons\\read.gif";
        ...
        public ReadIcon(Point startLocation) :
            base(startLocation)
        {
            Diagram = new ReadIconStructure();
            Text = new DP_Text();
        ...
        {
            ReadIcon newType = new ReadIcon();
            newType.Diagram = new ReadIconStructure();
        ...
        {
            if (source is ReadIcon)
            {
              base.Copy(source);
              ReadIcon srcReadIcon = source as ReadIcon;
            }
        }
    }
}
