...
{
    public class Message : CollabObject
    {
        ...
        public Message(Point startLocation) :
            base(startLocation)
        {
            Diagram = new MessageStructure();
            Text = new DP_Text();
        ...
        {
            Message newType = new Message();
            newType.Diagram = new MessageStructure();
        ...
        protected override void Copy(DP_ConcreteType source)
        {
            ...
            {
              base.Copy(source);
              Message srcMessage = source as Message;
            }
        }
    }
}
