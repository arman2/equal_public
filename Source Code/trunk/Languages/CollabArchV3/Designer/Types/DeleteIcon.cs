...
{
    public class DeleteIcon : ActionIcon
    {
        ...
        protected override void SetParams()
        {
            ...
            ShapeProperties.Icon = "..\\..\\Icons\\delete.gif";
        ...
        public DeleteIcon(Point startLocation) :
            base(startLocation)
        {
            Diagram = new DeleteIconStructure();
            Text = new DP_Text();
        ...
        {
            DeleteIcon newType = new DeleteIcon();
            newType.Diagram = new DeleteIconStructure();
        ...
        {
            if (source is DeleteIcon)
            {
              base.Copy(source);
              DeleteIcon srcDeleteIcon = source as DeleteIcon;
            }
        }
    }
}
