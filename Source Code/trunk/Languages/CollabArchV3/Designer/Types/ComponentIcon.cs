...
{
    public class ComponentIcon : CollabIcon
    {
        ...
        protected override void SetParams()
        {
            ...
            ShapeProperties.Icon = "..\\..\\Icons\\component.gif";
        ...
        public ComponentIcon(Point startLocation) :
            base(startLocation)
        {
            Diagram = new ComponentIconStructure();
            Text = new DP_Text();
        ...
        {
            ComponentIcon newType = new ComponentIcon();
            newType.Diagram = new ComponentIconStructure();
        ...
        {
            if (source is ComponentIcon)
            {
              base.Copy(source);
              ComponentIcon srcComponentIcon = source as ComponentIcon;
            }
        }
    }
}
