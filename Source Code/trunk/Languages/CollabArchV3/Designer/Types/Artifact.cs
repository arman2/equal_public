...
{
    public class Artifact : CollabObject
    {
        ...
        public Artifact(Point startLocation) :
            base(startLocation)
        {
            Diagram = new ArtifactStructure();
            Text = new DP_Text();
        ...
        {
            Artifact newType = new Artifact();
            newType.Diagram = new ArtifactStructure();
        ...
        {
            if (source is Artifact)
            {
              base.Copy(source);
              Artifact srcArtifact = source as Artifact;
            }
        }
    }
}
