...
{
    public class CreateIcon : ActionIcon
    {
        ...
        protected override void SetParams()
        {
            ...
            ShapeProperties.Icon = "..\\..\\Icons\\create.gif";
        ...
        public CreateIcon(Point startLocation) :
            base(startLocation)
        {
            Diagram = new CreateIconStructure();
            Text = new DP_Text();
        ...
        {
            CreateIcon newType = new CreateIcon();
            newType.Diagram = new CreateIconStructure();
        ...
        {
            if (source is CreateIcon)
            {
              base.Copy(source);
              CreateIcon srcCreateIcon = source as CreateIcon;
            }
        }
    }
}
