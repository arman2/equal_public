...
{
    public class UpdateIcon : ActionIcon
    {
        ...
        protected override void SetParams()
        {
            ...
            ShapeProperties.Icon = "..\\..\\Icons\\update.gif";
        ...
        public UpdateIcon(Point startLocation) :
            base(startLocation)
        {
            Diagram = new UpdateIconStructure();
            Text = new DP_Text();
        ...
        {
            UpdateIcon newType = new UpdateIcon();
            newType.Diagram = new UpdateIconStructure();
        ...
        {
            if (source is UpdateIcon)
            {
              base.Copy(source);
              UpdateIcon srcUpdateIcon = source as UpdateIcon;
            }
        }
    }
}
