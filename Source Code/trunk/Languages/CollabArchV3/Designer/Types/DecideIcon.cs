...
{
    public class DecideIcon : ActionIcon
    {
        ...
        protected override void SetParams()
        {
            ...
            ShapeProperties.Icon = "..\\..\\Icons\\decide.gif";
        ...
        public DecideIcon(Point startLocation) :
            base(startLocation)
        {
            Diagram = new DecideIconStructure();
            Text = new DP_Text();
        ...
        {
            DecideIcon newType = new DecideIcon();
            newType.Diagram = new DecideIconStructure();
        ...
        {
            if (source is DecideIcon)
            {
              base.Copy(source);
              DecideIcon srcDecideIcon = source as DecideIcon;
            }
        }
    }
}
