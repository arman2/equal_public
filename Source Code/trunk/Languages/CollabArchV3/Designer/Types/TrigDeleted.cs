...
{
    public class TrigDeleted : Trigger
    {
        ...
        public TrigDeleted(Point startLocation) :
            base(startLocation)
        {
            Diagram = new TrigDeletedStructure();
            Text = new DP_Text();
        ...
        {
            TrigDeleted newType = new TrigDeleted();
            newType.Diagram = new TrigDeletedStructure();
        ...
        {
            if (source is TrigDeleted)
            {
              base.Copy(source);
              TrigDeleted srcTrigDeleted = source as TrigDeleted;
            }
        }
    }
}
