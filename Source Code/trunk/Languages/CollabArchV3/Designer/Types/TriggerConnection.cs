...
{
    public class TriggerConnection : DP_Line
    {
        ...
        public TriggerConnection(DomainProDesigner.DP_ConnectionSpec newRole1, DomainProDesigner.DP_ConnectionSpec newRole2) :
            base(newRole1, newRole2)
        {
            Diagram = new TriggerConnectionStructure();
            Text = new DP_Text();
        ...
        {
            TriggerConnection newType = new TriggerConnection();
            newType.Diagram = new TriggerConnectionStructure();
        ...
        {
            if (source is TriggerConnection)
            {
              base.Copy(source);
              TriggerConnection srcTriggerConnection = source as TriggerConnection;
            }
        }
    }
}
