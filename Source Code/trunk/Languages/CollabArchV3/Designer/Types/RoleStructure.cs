...
namespace Designer.Types
{
    public class RoleStructure : DP_Diagram
    {
        public RoleStructure()
        {
            ...
            availableShapes.Add("ComponentIcon");
            availableShapes.Add("ConnectorIcon");
        ...
        public override DP_Shape CreateShape(string shapeType, Point startLocation)
        {
            ...
            if (shapeType == "ComponentIcon")
            {
                ComponentIcon newShape = new ComponentIcon(startLocation);
                newShape.Initialize(this);
                return newShape;
            }

            if (shapeType == "ConnectorIcon")
            {
                ConnectorIcon newShape = new ConnectorIcon(startLocation);
                newShape.Initialize(this);
                return newShape;
            }
