...
{
    public class FocusedOn : DP_Line
    {
        ...
        public FocusedOn(DomainProDesigner.DP_ConnectionSpec newRole1, DomainProDesigner.DP_ConnectionSpec newRole2) :
            base(newRole1, newRole2)
        {
            Diagram = new FocusedOnStructure();
            Text = new DP_Text();
        }
        ...
        {
            FocusedOn newType = new FocusedOn();
            newType.Diagram = new FocusedOnStructure();
        ...
        {
            if (source is FocusedOn)
            {
              base.Copy(source);
              FocusedOn srcFocusedOn = source as FocusedOn;
            }
        }
    }
}
