...
{
    public class TrigUpdated : Trigger
    {
        ...
        public TrigUpdated(Point startLocation) :
            base(startLocation)
        {
            Diagram = new TrigUpdatedStructure();
            Text = new DP_Text();
        ...
        {
            TrigUpdated newType = new TrigUpdated();
            newType.Diagram = new TrigUpdatedStructure();
        ...
        {
            if (source is TrigUpdated)
            {
              base.Copy(source);
              TrigUpdated srcTrigUpdated = source as TrigUpdated;
            }
        }
    }
}
