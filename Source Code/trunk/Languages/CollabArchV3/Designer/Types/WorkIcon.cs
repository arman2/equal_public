...
{
    public class WorkIcon : ActionIcon
    {
        ...
        protected override void SetParams()
        {
            ...
            ShapeProperties.Icon = "..\\..\\Icons\\work.gif";
        ...
        public WorkIcon(Point startLocation) :
            base(startLocation)
        {
            Diagram = new WorkIconStructure();
            Text = new DP_Text();
        ...
        {
            WorkIcon newType = new WorkIcon();
            newType.Diagram = new WorkIconStructure();
        ...
        {
            if (source is WorkIcon)
            {
              base.Copy(source);
              WorkIcon srcWorkIcon = source as WorkIcon;
            }
        }
    }
}
