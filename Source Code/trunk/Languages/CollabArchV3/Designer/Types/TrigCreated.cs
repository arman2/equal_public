...
namespace Designer.Types
{
    public class TrigCreated : Trigger
    {
        ...
        public TrigCreated(Point startLocation) :
            base(startLocation)
        {
            Diagram = new TrigCreatedStructure();
            Text = new DP_Text();
        ...
        {
            TrigCreated newType = new TrigCreated();
            newType.Diagram = new TrigCreatedStructure();
        ...
        {
            if (source is TrigCreated)
            {
              base.Copy(source);
              TrigCreated srcTrigCreated = source as TrigCreated;
            }
        }
    }
}
