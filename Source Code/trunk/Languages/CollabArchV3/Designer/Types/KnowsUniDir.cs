...
{
    public class KnowsUniDir : DP_Line
    {
        ...
        public KnowsUniDir(DomainProDesigner.DP_ConnectionSpec newRole1, DomainProDesigner.DP_ConnectionSpec newRole2) :
            base(newRole1, newRole2)
        {
            Diagram = new KnowsUniDirStructure();
            Text = new DP_Text();
        }
        ...
        {
            KnowsUniDir newType = new KnowsUniDir();
            newType.Diagram = new KnowsUniDirStructure();
        ...
        {
            if (source is KnowsUniDir)
            {
              base.Copy(source);
              KnowsUniDir srcKnowsUniDir = source as KnowsUniDir;
            }
        }
    }
}
