...
{
    public class StreamIcon : ObjectIcon
    {
        ...
        protected override void SetParams()
        {
            ...
            ShapeProperties.Icon = "..\\..\\Icons\\stream.gif";
        ...
        public StreamIcon(Point startLocation) :
            base(startLocation)
        {
            Diagram = new StreamIconStructure();
            Text = new DP_Text();
        ...
        {
            StreamIcon newType = new StreamIcon();
            newType.Diagram = new StreamIconStructure();
        ...
        {
            if (source is StreamIcon)
            {
              base.Copy(source);
              StreamIcon srcStreamIcon = source as StreamIcon;
            }
        }
    }
}
