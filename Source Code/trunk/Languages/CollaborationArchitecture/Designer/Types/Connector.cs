...
{
    public class Connector : Collaborator
    {
        ...
        public Connector(Point startLocation) :
            base(startLocation)
        {
            Diagram = new ConnectorStructure();
            Text = new DP_Text();
        ...
        {
            Connector newType = new Connector();
            newType.Diagram = new ConnectorStructure();
        ...
        protected override void Copy(DP_ConcreteType source)
        {
            ...
            {
              base.Copy(source);
              Connector srcConnector = source as Connector;
            }
        }
    }
}
