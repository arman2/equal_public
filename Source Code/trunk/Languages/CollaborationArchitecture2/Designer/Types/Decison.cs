...
{
    public class Decison : CollabStep
    {
        ...
        public Decison(Point startLocation) :
            base(startLocation)
        {
            Diagram = new DecisonStructure();
            Text = new DP_Text();
        ...
        {
            Decison newType = new Decison();
            newType.Diagram = new DecisonStructure();
        ...
        {
            if (source is Decison)
            {
              base.Copy(source);
              Decison srcDecison = source as Decison;
        ResourceDependency = srcDecison.ResourceDependency;
        ResourceRequest = srcDecison.ResourceRequest;
            }
        }
    }
}
