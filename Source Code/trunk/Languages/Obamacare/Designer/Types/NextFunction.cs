...
{
    public class NextFunction : DP_Line
    {
        ...
        protected override void SetParams()
        {
            ...
            role1Name = "CallingFunction";
            role2Name = "CalledFunction";
        }
        ...
        public NextFunction(DomainProDesigner.DP_ConnectionSpec newRole1, DomainProDesigner.DP_ConnectionSpec newRole2) :
            base(newRole1, newRole2)
        {
            Diagram = new NextFunctionStructure();
            Text = new DP_Text();
        ...
        {
            NextFunction newType = new NextFunction();
            newType.Diagram = new NextFunctionStructure();
        ...
        {
            if (source is NextFunction)
            {
              base.Copy(source);
              NextFunction srcNextFunction = source as NextFunction;
            }
        }
    }
}
