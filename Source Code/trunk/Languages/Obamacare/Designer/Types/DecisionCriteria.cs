...
{
    public class DecisionCriteria : DP_Shape
    {
        ...
        public DecisionCriteria(Point startLocation) :
            base(startLocation)
        {
            Diagram = new DecisionCriteriaStructure();
            Text = new DP_Text();
        ...
        {
            DecisionCriteria newType = new DecisionCriteria();
            newType.Diagram = new DecisionCriteriaStructure();
        ...
        {
            if (source is DecisionCriteria)
            {
              base.Copy(source);
              DecisionCriteria srcDecisionCriteria = source as DecisionCriteria;
            }
        }
    }
}
