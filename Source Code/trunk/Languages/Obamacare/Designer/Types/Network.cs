...
namespace Designer.Types
{
    public class Network : DP_Line
    {
        ...
        protected override void SetParams()
        {
            ...
            LineProperties.Role1.Icon = "..\\..\\Icons\\largearrow.gif";
        ...
        public Network(DomainProDesigner.DP_ConnectionSpec newRole1, DomainProDesigner.DP_ConnectionSpec newRole2) :
            base(newRole1, newRole2)
        {
            Diagram = new NetworkStructure();
            Text = new DP_Text();
        }
        ...
        {
            Network newType = new Network();
            newType.Diagram = new NetworkStructure();
        ...
        protected override void Copy(DP_ConcreteType source)
        {
            ...
            {
              base.Copy(source);
              Network srcNetwork = source as Network;
            }
        }
    }
}
