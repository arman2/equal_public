...
{
    public class MyQueueingModel : DP_Shape
    {
        ...
        public MyQueueingModel()
        {
        }

        public MyQueueingModel(Point startLocation) :
            base(startLocation)
        {
            Diagram = new MyQueueingModelStructure();
            Text = new DP_Text();
        ...
        {
            MyQueueingModel newType = new MyQueueingModel();
            newType.Diagram = new MyQueueingModelStructure();
        ...
        {
            if (source is MyQueueingModel)
            {
              base.Copy(source);
              MyQueueingModel srcMyQueueingModel = source as MyQueueingModel;
            }
        }
    }
}
