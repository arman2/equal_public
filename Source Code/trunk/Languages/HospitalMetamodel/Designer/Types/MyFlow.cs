...
namespace Designer.Types
{
    public class MyFlow : DP_Line
    {
        ...
        {
            if (endpoint is MyStep)
            {
                return true;
            }
            if (endpoint is MySource)
            {
                return true;
            }
            return false;
        ...
        protected override void SetParams()
        {
            ...
            LineProperties.Role2.Icon = "C:\\Users\\Michael\\Documents\\DomainPro\\trunk\\Icons\\arrow.gif";
        ...
        public MyFlow(DomainProDesigner.DP_ConnectionSpec newRole1, DomainProDesigner.DP_ConnectionSpec newRole2) :
            base(newRole1, newRole2)
        {
            Diagram = new MyFlowStructure();
            Text = new DP_Text();
        ...
        {
            MyFlow newType = new MyFlow();
            newType.Diagram = new MyFlowStructure();
        ...
        protected override void Copy(DP_ConcreteType source)
        {
            ...
            {
              base.Copy(source);
              MyFlow srcMyFlow = source as MyFlow;
            }
        }
    }
}
