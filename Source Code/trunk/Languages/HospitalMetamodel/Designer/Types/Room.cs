...
namespace Designer.Types
{
    public class Room : DP_Shape
    {
        ...
        public Room(Point startLocation) :
            base(startLocation)
        {
            Diagram = new RoomStructure();
            Text = new DP_Text();
        ...
        {
            Room newType = new Room();
            newType.Diagram = new RoomStructure();
