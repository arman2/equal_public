...
{
    public class NursePractitioners : AllNurses
    {
        ...
        public NursePractitioners()
        {
        }

        public NursePractitioners(Point startLocation) :
            base(startLocation)
        {
            Diagram = new NursePractitionersStructure();
            Text = new DP_Text();
        }
        ...
        {
            NursePractitioners newType = new NursePractitioners();
            newType.Diagram = new NursePractitionersStructure();
        ...
        {
            if (source is NursePractitioners)
            {
              base.Copy(source);
              NursePractitioners srcNursePractitioners = source as NursePractitioners;
        Workers = srcNursePractitioners.Workers;
        Queues = srcNursePractitioners.Queues;
            }
        }
    }
}
