...
{
    public class Hospital : DP_Shape
    {
        ...
        public Hospital(Point startLocation) :
            base(startLocation)
        {
            Diagram = new HospitalStructure();
            Text = new DP_Text();
        ...
        public override DP_ConcreteType Duplicate()
        {
            ...
            newType.Diagram = new HospitalStructure();
        ...
        protected override void Copy(DP_ConcreteType source)
        {
            ...
            {
              base.Copy(source);
              Hospital srcHospital = source as Hospital;
            }
        }
    }
}
