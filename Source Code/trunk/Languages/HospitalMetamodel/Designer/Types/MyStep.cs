...
namespace Designer.Types
{
    public class MyStep : DP_Shape
    {
        ...
        public MyStep(Point startLocation) :
            base(startLocation)
        {
            Diagram = new MyStepStructure();
            Text = new DP_Text();
        ...
        {
            MyStep newType = new MyStep();
            newType.Diagram = new MyStepStructure();
        ...
        protected override void Copy(DP_ConcreteType source)
        {
            ...
            {
              base.Copy(source);
              MyStep srcMyStep = source as MyStep;
        ResourceDependency = srcMyStep.ResourceDependency;
        ResourceRequest = srcMyStep.ResourceRequest;
            }
        }
    }
}
