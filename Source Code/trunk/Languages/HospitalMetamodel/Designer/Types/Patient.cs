...
namespace Designer.Types
{
    public class Patient : DP_Shape
    {
        ...
        public Patient(Point startLocation) :
            base(startLocation)
        {
            Diagram = new PatientStructure();
            Text = new DP_Text();
        ...
        {
            Patient newType = new Patient();
            newType.Diagram = new PatientStructure();
        ...
        protected override void Copy(DP_ConcreteType source)
        {
            ...
            {
              base.Copy(source);
              Patient srcPatient = source as Patient;
            }
        }
    }
}
