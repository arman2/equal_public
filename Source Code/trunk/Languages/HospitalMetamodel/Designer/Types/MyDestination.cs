...
{
    public class MyDestination : DP_Shape
    {
        ...
        public MyDestination(Point startLocation) :
            base(startLocation)
        {
            Diagram = new MyDestinationStructure();
            Text = new DP_Text();
        ...
        {
            MyDestination newType = new MyDestination();
            newType.Diagram = new MyDestinationStructure();
        ...
        {
            if (source is MyDestination)
            {
              base.Copy(source);
              MyDestination srcMyDestination = source as MyDestination;
        ResourceDependency = srcMyDestination.ResourceDependency;
        ResourceRequest = srcMyDestination.ResourceRequest;
            }
        }
    }
}
