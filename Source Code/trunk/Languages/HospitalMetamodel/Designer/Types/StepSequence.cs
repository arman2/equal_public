...
{
    public class StepSequence : DP_Line
    {
        ...
        protected override void SetParams()
        {
            ...
            LineProperties.Role2.Icon = "C:\\bcs\\proto\\DomainPro\\Icons\\arrow.gif";

            Name = "NewStepSequence";
            DisplayName = Name;
            ShowName = false;
        ...
        public StepSequence(DomainProDesigner.DP_ConnectionSpec newRole1, DomainProDesigner.DP_ConnectionSpec newRole2) :
            base(newRole1, newRole2)
        {
            Diagram = new StepSequenceStructure();
            Text = new DP_Text();
        ...
        {
            StepSequence newType = new StepSequence();
            newType.Diagram = new StepSequenceStructure();
        ...
        {
            if (source is StepSequence)
            {
              base.Copy(source);
              StepSequence srcStepSequence = source as StepSequence;
            }
        }
    }
}
