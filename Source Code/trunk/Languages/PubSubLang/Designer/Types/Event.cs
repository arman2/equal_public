...
namespace Designer.Types
{
    public class Event : DP_Shape
    {
        ...
        public Event(Point startLocation) :
            base(startLocation)
        {
            Diagram = new EventStructure();
            Text = new DP_Text();
        }
        ...
        public override DP_ConcreteType Duplicate()
        {
            ...
            newType.Diagram = new EventStructure();
        ...
        protected override void Copy(DP_ConcreteType source)
        {
            ...
            {
              base.Copy(source);
              Event srcEvent = source as Event;
        ImplementationType = srcEvent.ImplementationType;
        InitialValue = srcEvent.InitialValue;
            }
        }
    }
}
