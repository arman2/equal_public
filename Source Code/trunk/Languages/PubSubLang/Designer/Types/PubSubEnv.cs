...
{
    public class PubSubEnv : DP_Shape
    {
        ...
        public PubSubEnv(Point startLocation) :
            base(startLocation)
        {
            Diagram = new PubSubEnvStructure();
            Text = new DP_Text();
        ...
        {
            PubSubEnv newType = new PubSubEnv();
            newType.Diagram = new PubSubEnvStructure();
        ...
        {
            if (source is PubSubEnv)
            {
              base.Copy(source);
              PubSubEnv srcPubSubEnv = source as PubSubEnv;
            }
        }
    }
}
