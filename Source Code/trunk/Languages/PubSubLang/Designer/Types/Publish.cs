...
namespace Designer.Types
{
    public class Publish : Action
    {
        ...
        public Publish(Point startLocation) :
            base(startLocation)
        {
            Diagram = new PublishStructure();
            Text = new DP_Text();
        ...
        {
            Publish newType = new Publish();
            newType.Diagram = new PublishStructure();
        ...
        {
            if (source is Publish)
            {
              base.Copy(source);
              Publish srcPublish = source as Publish;
            }
        }
    }
}
