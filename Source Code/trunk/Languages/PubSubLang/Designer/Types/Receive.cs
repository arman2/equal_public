...
namespace Designer.Types
{
    public class Receive : Action
    {
        ...
        public Receive(Point startLocation) :
            base(startLocation)
        {
            Diagram = new ReceiveStructure();
            Text = new DP_Text();
        ...
        {
            Receive newType = new Receive();
            newType.Diagram = new ReceiveStructure();
        ...
        {
            if (source is Receive)
            {
              base.Copy(source);
              Receive srcReceive = source as Receive;
            }
        }
    }
}
