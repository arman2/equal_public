...
namespace Designer.Types
{
    public class Peer : DP_Shape
    {
        ...
        public Peer(Point startLocation) :
            base(startLocation)
        {
            Diagram = new PeerStructure();
            Text = new DP_Text();
        ...
        {
            Peer newType = new Peer();
            newType.Diagram = new PeerStructure();
