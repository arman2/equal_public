...
namespace Designer.Types
{
    public class Action : DP_Shape
    {
        ...
        public Action(Point startLocation) :
            base(startLocation)
        {
            Diagram = new ActionStructure();
            Text = new DP_Text();
        ...
        {
            Action newType = new Action();
            newType.Diagram = new ActionStructure();
        ...
        protected override void Copy(DP_ConcreteType source)
        {
            ...
            {
              base.Copy(source);
              Action srcAction = source as Action;
        ResourceDependency = srcAction.ResourceDependency;
        ResourceRequest = srcAction.ResourceRequest;
            }
        }
    }
}
