...
namespace Designer.Types
{
    public class Forward : Action
    {
        ...
        public Forward(Point startLocation) :
            base(startLocation)
        {
            Diagram = new ForwardStructure();
            Text = new DP_Text();
        ...
        {
            Forward newType = new Forward();
            newType.Diagram = new ForwardStructure();
        ...
        {
            if (source is Forward)
            {
              base.Copy(source);
              Forward srcForward = source as Forward;
            }
        }
    }
}
