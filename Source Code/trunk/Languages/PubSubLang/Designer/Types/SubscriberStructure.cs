...
{
    public class SubscriberStructure : DP_Diagram
    {
        public SubscriberStructure()
        {
            availableShapes.Add("Subscribe");
        ...
        {
            if (shapeType == "Subscribe")
            {
                Subscribe newShape = new Subscribe(startLocation);
