...
namespace Designer.Types
{
    public class Subscribe : Action
    {
        ...
        public Subscribe(Point startLocation) :
            base(startLocation)
        {
            Diagram = new SubscribeStructure();
            Text = new DP_Text();
        ...
        {
            Subscribe newType = new Subscribe();
            newType.Diagram = new SubscribeStructure();
        ...
        {
            if (source is Subscribe)
            {
              base.Copy(source);
              Subscribe srcSubscribe = source as Subscribe;
            }
        }
    }
}
